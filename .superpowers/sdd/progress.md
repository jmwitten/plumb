...
- Task 3: complete (commits c0d1f64..b16f42c, review clean after one fix wave). A 30 mm slab preserves 34.5 in AFF, runner-derived box dimensions receive conditional cut authority, stone and runner machining remain withheld, and unsafe mutations withdraw drawer cuts; 62 scoped tests passed.
- Task 4: complete (commits e34318a..b5058eb, review clean after one fix wave). Three Rakks supports carry a canonical 1,256.39 lb factored comparison load with zero rail credit; manufacturer data, load inputs, and provisional authority are mutation-pinned while real connection approval remains held; 93 relevant tests passed.
- Task 5: complete (commits cd4b834..da5ac97, review clean after two fix waves). Four deterministic documents now project model-derived fabrication/installation/trade/commissioning states, fail closed on held geometry and unmapped routing, label every assumption, and eliminate cross-page authority contradictions; 107 relevant tests passed.
- Task 6: complete (commits 4be028a..07842c6, adversarial and no-context installer reviews clean after final fix waves). Official Blum box geometry, asymmetric service-derived U wings, UNKNOWN load distribution, support-first diagrams, complete conditional shop basis, explicit datums, written fabricator acceptance as the sole fabrication transition, and consistent veneer/joinery authority are delivered; 154 scoped tests passed.

## DV72 cabinet installation guide — 2026-07-15

- Task 1: complete (commits aada087..afda7fb, review clean). Reusable pure action-frame and Letter-page grammar matches the current instruction-grammar reference byte-for-byte; 47 focused tests passed.
- Task 2: complete (commits afda7fb..670ded4, review clean after one fix wave). Seven-sheet typed conditional guide projection, inline support/cabinet geometry, safe relative links, model-derived drawer-clearance facts, and post-HOLD record conditionality are delivered; 162 regression tests passed.
- Task 3: complete through `dbf82af` (commits `38d9274..dbf82af`) after independent whole-branch, technical, and no-context installer reviews, all clean. One typed five-rule release mapping now drives guide validation/rendering and the all-five-document semantic audit, including case-insensitive rejection of contradictory structural, wall-mount, installation, and load-authority approval language. Safe placement follows only accepted handling/support/restraint and cabinet case/interface records; the Rakks diagram projects the typed countertop-arm-to-diagonal-to-wall load path without capacity claims; field/release/final records are explicit; responsive and print behavior is executable under local Chrome; and hardware lettering is unbounded through `AAA` and beyond. The final scoped suite passed 295 tests, true rendered visible text including SVG labels is 1,469 words, deterministic generation was byte-identical, and the corrected seven-page Letter PDF rendered cleanly. Final guide SHA-256: `8be60cb0be829501b028ab5993c2954221e44c0d974d9d74d3b3f0b6da70c16c`.
