...
- Task 6: complete (commits 4be028a..a324943, adversarial and no-context installer reviews clean after final fix waves). Official Blum box geometry, asymmetric service-derived U wings, UNKNOWN load distribution, support-first diagrams, complete conditional shop basis, explicit datums, written fabricator acceptance, and consistent veneer/joinery authority are delivered; 115 focused tests passed.
